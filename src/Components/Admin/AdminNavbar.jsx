...
export const AdminNavbar = () => {
    ...
    return (
        <Container>
            <Left>
                {
                    links.map(item=><Link key={item.to} style={{textDecoration:'none', color:'#fff'}} to={item.to} ><NavContents>{item.title}</NavContents></Link>)
                }
            </Left>
            <Right>
                <NavContents><span className="material-icons">forum</span></NavContents>
                <NavContents><span className="material-icons">notifications</span></NavContents>
                <NavContents onClick={handleAdmDisp} ><span className="material-icons">person</span></NavContents>
                {
