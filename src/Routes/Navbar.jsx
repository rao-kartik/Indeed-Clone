        ...
        <>
            <Container>
                <div style={{display:'flex'}} >
                    ...
                    {
                        leftLinks.map(link=> <NavLink className={styles.navContents} activeClassName={styles.active} style={{textDecoration:'none', color:'#2d2d2d'}} to={link.to} ><P>{link.title}</P></NavLink>)
                    }
