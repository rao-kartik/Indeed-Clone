...
const rightLinksAfterSignin = [
    {
        to: '/conversations',
        title: <span className="material-icons">forum</span>
    },
    {
        to: '/notifications',
        title: <span className="material-icons">notifications</span>
    }
]
                ...
                <div style={{display:'flex'}} >
                        {
                            !isAuth ? (
                                <>
                                    {
                                    rightLinksBeforeSignin.map(link=> <NavContents key={link.to}><Link style={{textDecoration:'none', color:'#2d2d2d'}} to={link.to} >{link.title}</Link></NavContents>)
                                    }
                                ...
                                <>
                                    {
                                        rightLinksAfterSignin.map(link=> <NavContents key={link.to}><Link style={{textDecoration:'none', color:'#000'}} to={link.to} >{link.title}</Link></NavContents>)
                                    }
                                    <NavContents onClick={handleUserDisp} ><span className="material-icons">person</span></NavContents>
                                    {
