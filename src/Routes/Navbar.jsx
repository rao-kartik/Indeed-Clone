...
const rightLinksAfterSignin = [
    {
        to: '/conversations',
        title: <span class="material-icons">forum</span>
    },
    {
        to: '/notifications',
        ...
        <>
            <Container>
                <div style={{display:'flex'}} >
                    ...
                    {
                        leftLinks.map(link=> <NavLink exact className={styles.navContents} activeClassName={styles.active} style={{textDecoration:'none', color:'#2d2d2d'}} to={link.to} ><P>{link.title}</P></NavLink>)
                    }
