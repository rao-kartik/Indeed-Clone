        ...
        <>
            <Container>
                <div style={{display:'flex'}} >
                    ...
                    <NavContents style={{borderBottom:'2px solid blue'}} ><Link style={{textDecoration:'none', color:'#2d2d2d'}} to='/' >Find Jobs</Link></NavContents>

                    {
                        leftLinks.map(link=> <NavContents><Link style={{textDecoration:'none', color:'#2d2d2d'}} to={link.to} >{link.title}</Link></NavContents>)
                    }
